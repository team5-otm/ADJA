...
{
	private static final String AUTHENTICATION_SERVER_ADDRESS = "http://137.116.165.53/android-im_WEBAPI/"; //TODO change to your WebAPI Address
	...
	{		
		...
		//	InetAddress serverAddress = InetAddress.getByName(AUTHENTICATION_SERVER_ADDRESS);
        //    SocketAddress socketaddress = new InetSocketAddress(serverAddress,3306 );
		//	Proxy proxy = new Proxy(Proxy.Type.SOCKS, socketaddress); http port:80
