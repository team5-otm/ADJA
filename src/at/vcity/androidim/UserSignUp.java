...
//	private static final String SERVER_RES_SIGN_UP_FAILED = "0";
	...
	private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            // see this happen.
        	imService = null;
            Toast.makeText(UserSignUp.this, R.string.local_service_stopped,
											...
											handler.post(new Runnable(){
												...
												public void run() {
													if (result.equals(SERVER_RES_RES_SIGN_UP_SUCCESFULL)) {
														...
														handler.post(new Runnable(){
															public void run() {										
																Intent i = new Intent(UserSignUp.this, UserSignIn.class);												
	...
	{    	
		...
		switch (id) 
		{
			case TYPE_SAME_PASSWORD_IN_PASSWORD_FIELDS:			
				return new AlertDialog.Builder(UserSignUp.this)       
...
//				.create();	
	...
	protected void onResume() {
		bindService(new Intent(UserSignUp.this, IMService.class), mConnection , Context.BIND_AUTO_CREATE);
